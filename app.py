...
# ======================================================
# BASE ONLINE (CSV RAW)
# 👉 coloque um CSV REAL aqui (GitHub raw)
# ======================================================
URL_BASE_ONLINE = (
    "https://raw.githubusercontent.com/SEU_USUARIO/SEU_REPO/main/lotofacil_resultados.csv"
)
...
janela = st.sidebar.slider("Janela histórica", 50, 3000, 300)
